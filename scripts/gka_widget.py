"""Moved into the package -> mascope_assign/gka_widget.py.

Preferred: `mascope-assign gka LEDGER.csv [-o out.html] [--ppm 2]`
       or  `python3 -m mascope_assign.gka_widget LEDGER.csv ...`
...
from mascope_assign.gka_widget import main  # noqa: E402
